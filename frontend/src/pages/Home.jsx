      ...
      <section className="text-center space-y-6 py-8">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center mt-4">
          <button 
            ...
            className="inline-flex items-center cursor-pointer justify-center gap-2 bg-blue-600 text-white hover:bg-blue-700 px-8 py-3 rounded-lg text-sm font-medium transition-colors shadow-sm"
          >
            Report an Item
          ...
          <button 
            ...
            className="inline-flex items-center justify-center bg-white text-gray-700 border cursor-pointer border-gray-300 hover:bg-gray-50 px-8 py-3 rounded-lg text-sm font-medium transition-colors shadow-sm"
          >
            Search Lost & Found
          </button>
        </div>
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          <div className="lg:ml-[650px] ml-[70px]">
            <h2 className="text-2xl ml-8 font-bold text-gray-900">Recent Matches</h2>
